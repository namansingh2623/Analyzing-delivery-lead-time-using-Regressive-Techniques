...
model_lr_newfeatures <- lm(Time_taken.min. ~Delivery_person_Age+Delivery_person_Ratings+EmployeeEfficiency+Festival+multiple_deliveries+LateDelivery, data = delivery_data_mask)
summary(model_lr_newfeatures)
